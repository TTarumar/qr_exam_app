...
import 'package:qr_exam_app/view/desktop/desktop_qr_view.dart';
                              ...
                              onTap: () {
                                Navigator.push(
                                  ...
                                  PageTransition(
                                    ...
                                    child: TimerView(async.data[index]["name"],
                                        async.data[index]["id"],userViewModel.userModel.id),
                                  ),
                                );
                              },
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: ColorFiltered(
                                    ...
                                    child: Image.asset(
                                      async.data[index]["name"].toString().contains("Öğrenme")
                                          ? "assets/courses/tur.jpg"
                                          : async.data[index]["name"].toString().contains("Ölçme")
                                              ? "assets/courses/mat.jpg"
                                              : async.data[index]["name"].toString().contains("Özel Eğitim")
                                                  ? "assets/courses/fizik.jpg"
                                                  : async.data[index]["name"].toString().contains("Çevre Eğitimi")
                                                      ? "assets/courses/sci.jpg"
                                                      : async.data[index]["name"].toString().contains("Sosyal Etkileşim")
                                                          ? "assets/courses/bio.jpg"
                                                          : async.data[index]["name"].toString().contains("Dijital")
                                                              ? "assets/courses/history.png"
                                                              : async.data[index]["name"].toString().contains("Güvenli Okul")
                                                                  ? "assets/courses/edebiyat.jpg"
                                                                  : async.data[index]["name"].toString().contains("Liderlik")
